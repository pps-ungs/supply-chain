...
#    Jun 28, 2025 03:27:27 PM -03  platform: Linux
...
class MainWindow:
    def __init__(self, top=None):
        ...
        self.TEntry2.place(relx=0.5, rely=0.154, relheight=0.051, relwidth=0.457
                , bordermode='ignore')
        self.TEntry2.configure(takefocus="")
        self.TEntry2.configure(cursor="xterm")

        self.TEntry1 = ttk.Entry(self.TLabelframeInput)
        self.TEntry1.place(relx=0.5, rely=0.066, relheight=0.051, relwidth=0.469
                , bordermode='ignore')
        self.TEntry1.configure(takefocus="")
        self.TEntry1.configure(cursor="xterm")

        self.TLabelStep = ttk.Label(self.TLabelframeInput)
        self.TLabelStep.place(relx=0.029, rely=0.066, height=21, width=156
                , bordermode='ignore')
        ...
        self.TLabelMaxIter.place(relx=0.029, rely=0.154, height=21, width=156
                , bordermode='ignore')
